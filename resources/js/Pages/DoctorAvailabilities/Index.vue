<template>
  <div class="p-8">
    <div class="flex justify-between items-center mb-6">
      ...
      <Link :href="`/availabilities/create`" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded shadow">+ Nueva</Link>
    </div>
        ...
        <tr v-for="(a, i) in availabilities" :key="a.id" class="border-t hover:bg-gray-50">
          ...
          <td class="px-4 py-2 text-center">
            <div class="flex justify-center gap-2">
              <Link :href="`/availabilities/${a.id}`" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded">Ver</Link>
              <Link :href="`/availabilities/${a.id}/edit`" class="bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded">Editar</Link>
